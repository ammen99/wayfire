...
class wlr_surface_base_t
{
  ...
  public:
    ...
    wlr_surface_base_t(wlr_surface_base_t &&) = default;
    wlr_surface_base_t& operator =(const wlr_surface_base_t&) = delete;
    wlr_surface_base_t& operator =(wlr_surface_base_t&&) = default;
    ...
    public surface_interface_t, public wlr_surface_base_t
{
  public:
    ...
    wlr_child_surface_base_t(wlr_child_surface_base_t &&) = default;
    wlr_child_surface_base_t& operator =(const wlr_child_surface_base_t&) = delete;
    wlr_child_surface_base_t& operator =(wlr_child_surface_base_t&&) = default;
