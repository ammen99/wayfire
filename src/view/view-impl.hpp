...
struct view_transform_block_t
{
    ...
    view_transform_block_t(view_transform_block_t &&) = default;
    view_transform_block_t& operator =(const view_transform_block_t&) = delete;
    view_transform_block_t& operator =(view_transform_block_t&&) = default;
};
    ...
    public view_interface_t
{
  public:
    ...
    wlr_view_t(wlr_view_t &&) = default;
    wlr_view_t& operator =(const wlr_view_t&) = delete;
    wlr_view_t& operator =(wlr_view_t&&) = default;
