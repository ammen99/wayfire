...
struct animation_hook : public animation_hook_base
{
    ...
    animation_hook(animation_hook &&) = default;
    animation_hook& operator =(const animation_hook&) = delete;
    animation_hook& operator =(animation_hook&&) = default;
};
...
struct animation_global_cleanup_t
{
    ...
    animation_global_cleanup_t(animation_global_cleanup_t &&) = default;
    animation_global_cleanup_t& operator =(const animation_global_cleanup_t&) =
    delete;
    animation_global_cleanup_t& operator =(animation_global_cleanup_t&&) = default;
};
