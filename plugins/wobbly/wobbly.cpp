...
class iwobbly_state_t
{
  public:
    ...
    iwobbly_state_t(const iwobbly_state_t &) = default;
    iwobbly_state_t(iwobbly_state_t &&) = default;
...
class wobbly_state_tiled_t : public iwobbly_state_t
{
  public:
    ...
    wobbly_state_tiled_t(const wobbly_state_tiled_t &) = default;
    wobbly_state_tiled_t(wobbly_state_tiled_t &&) = default;
...
class wobbly_state_tiled_grabbed_t : public wobbly_state_grabbed_t
{
  public:
    ...
    wobbly_state_tiled_grabbed_t(const wobbly_state_tiled_grabbed_t &) = default;
    wobbly_state_tiled_grabbed_t(wobbly_state_tiled_grabbed_t &&) = default;
...
class wf_wobbly : public wf::view_transformer_t
{
  ...
  public:
    ...
    wf_wobbly(wf_wobbly &&) = default;
    wf_wobbly& operator =(const wf_wobbly&) = delete;
    wf_wobbly& operator =(wf_wobbly&&) = default;
};
